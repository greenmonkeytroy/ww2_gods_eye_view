> **Archived copy of the upstream README.** It describes the original God's Eye View, a live
> present-day intelligence console (flights, ships, satellites, CCTV, traffic, radio). This 1939-1945
> fork keeps those features dormant (see [../src/period.js](../src/period.js)) and has its own
> [README](../README.md). Image and link paths below are relative to the repository root.
